...
with_node \
  ...
  --target "/Users/wboone/Desktop/realones-app/ios/Pods/Target Support Files/Pods-realonesapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/wboone/Desktop/realones-app/ios/realonesapp/realonesapp.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-document-picker" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-web-browser"
